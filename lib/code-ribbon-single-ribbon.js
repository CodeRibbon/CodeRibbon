...
const PaneAxis = atom.workspace.getCenter().paneContainer.root.__proto__.constructor;

console.log("CR: Took PaneAxis as:");
console.log(PaneAxis);

export default class CodeRibbonSingleRibbon extends PaneAxis {
  ...
  constructor(state, viewRegistry) {
    super(state);
    console.log("CR:CodeRibbonSingleRibbon children:");
