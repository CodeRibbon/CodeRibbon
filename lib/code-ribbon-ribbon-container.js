...
class CodeRibbonRibbonContainer extends PaneAxis {
  ...
  toggle_zoom_mode() {
    if ( ! this.zoom_active ) {
      ...
      ap.cr_patch_zoom();
      this.element.classList.add('cr-zoom-active');
      this.zoom_active = ap;
    }
    else {
      ...
      // );
      this.element.classList.remove('cr-zoom-active');
      this.zoom_active.cr_patch_unzoom();
      this.previous_zoom_active = this.zoom_active;
      this.zoom_active = undefined;
    }
  }
