      ...
      elementForItem: ({filePath, label, ownerGitHubUsername}) => {
        ...
        switch (this.scoringSystem) {
          ...
          case SCORING_SYSTEMS.FAST:
            ...
            items = this.nativeFuzzyForResults.match(
              filterQuery,
...
class FuzzyFinderItem {
  constructor ({filePath, label, ownerGitHubUsername, filterQuery, matches, repository}) { // eslint-disable-line no-unused-vars
